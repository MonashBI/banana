...
# mrtrix_req('3.0') = CliRequirement('mrtrix', min_version=(3, 0, 0),
#                              test_cmd='mrconvert')
# fsl5_req = CliRequirement('fsl', min_version=(5, 0, 8), test_cmd='fsl')
# fsl_req('5.0.9') = CliRequirement('fsl', min_version=(5, 0, 9),
#                             max_version=(5, 0, 9), test_cmd='fsl')
# fsl_req('5.0.10') = CliRequirement('fsl', min_version=(5, 0, 10),
#                             max_version=(5, 0, 10), test_cmd='fsl')
# ants_req('2.0') = CliRequirement('ants', min_version=(2, 0),
#                            test_cmd='antsRegistration')
# ants_req('1.9') = CliRequirement('ants', min_version=(1, 9),
#                             test_cmd='antsRegistration')
# spm_req(12) = MatlabRequirement('spm', min_version=(12, 0),
#                               test_func=None)
# freesurfer_req('5.3') = CliRequirement('freesurfer', min_version=(5, 3))
# matlab_req('R2014a') = CliRequirement('matlab', min_version=(2014, 'a'),
#                                 version_split=matlab_version_split,
#                                 test_cmd='matlab')
# matlab_req('R2015a') = CliRequirement('matlab', min_version=(2015, 'a'),
#                                 version_split=matlab_version_split,
#                                 test_cmd='matlab')
# noddi_req = MatlabRequirement('noddi', min_version=(0, 9)),
# niftimatlab_req = MatlabRequirement('niftimatlib', (1, 2))
# dcm2niix_req('1.0.2') = CliRequirement('dcm2niix', min_version=(1, 0, 2),
#                               test_cmd='dcm2niix')
# fix_req('1.0') = CliRequirement('fix', min_version=(1, 0))
# afni_req('16.2.10') = CliRequirement('afni', min_version=(16, 2, 10))
# mricrogl_req = CliRequirement('mricrogl', min_version=(1, 0, 20170207))
# stir_req('3.0') = CliRequirement('stir', min_version=(3, 0))
# c3d_req('1.1.0') = CliRequirement('c3d', min_version=(1, 1, 0))

# matlab_req('R2015a') = Requirement('matlab', min_version=(2015, 'a'),
#                                 version_split=matlab_version_split,
#                                 test_cmd='matlab')
