...
class T2Study(MriStudy, metaclass=StudyMetaClass):
    ...
    def cet_T2s(self, **options):
        ...
        maths1 = pipeline.create_node(
            ...
            name='combine_masks', requirements=[fsl_req('5.0.8')], memory=16000,
            wall_time=5)
        ...
        maths2 = pipeline.create_node(
            fsl.utils.ImageMaths(
                ...
                op_string='-mas'),
            name='mask_t2s', requirements=[fsl_req('5.0.8')], memory=16000,
            wall_time=5)
        ...
        maths3 = pipeline.create_node(
            fsl.utils.ImageMaths(
                suffix='_optiBET_cerebellum',
                op_string='-mas'),
            name='mask_t2s_last_echo', requirements=[fsl_req('5.0.8')],
    ...
    def bet_T2s(self, **options):
        ...
        maths = pipeline.create_node(
            ...
            name='mask', requirements=[fsl_req('5.0.8')], memory=16000, wall_time=5)
