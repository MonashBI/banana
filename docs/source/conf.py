...
latex_documents = [
  (master_doc, 'banana.tex', u'Banana Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'banana', u'Banana Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Banana', u'Banana Documentation',
   author, 'Banana', 'Brain imAgiNg Analysis iN Arcana',
   'Miscellaneous'),
]
