...
from nianalysis.data_formats import nifti_gz_format, rdata_format, ica_format  # @IgnorePep8
...
class TestFMRI(BaseTestCase):
    ...
    def test_feat(self):
        ...
        self.assertDatasetCreated('feat_dir.ica', study.name)

    def test_fix(self):
        study = self.create_study(
            FunctionalMRIStudy, 'fix', input_datasets={
                'feat_dir': Dataset('feat_dir', ica_format),
