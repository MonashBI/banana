    ...
    def test_ute(self):
        study = self.create_study(
            UteStudy, 'registration', {
                InputFilesets('ute_echo1', 'ute_echo1', dicom_format),
                InputFilesets('ute_echo2', 'ute_echo2', dicom_format),
                InputFilesets('umap_ute', 'umap_ute', dicom_format)})
    ...
    def test_ute(self):
        study = self.create_study(
            UteStudy, 'segmentation', {
                InputFilesets('ute1_registered', 'ute1_registered', nifti_gz_format),})
    ...
    def test_ute(self):
        study = self.create_study(
            UteStudy, 'umap_creation', {
                InputFilesets('ute1_registered', 'ute1_registered', nifti_gz_format),
                InputFilesets('ute2_registered', 'ute2_registered', nifti_gz_format),
                InputFilesets('air_mask', 'air_mask', nifti_gz_format),
                InputFilesets('bones_mask', 'bones_mask', nifti_gz_format)})
