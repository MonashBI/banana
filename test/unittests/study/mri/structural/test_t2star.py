...
#                                      study_name=study.name)        
    ...
    def test_ants_t2star(self):
        study = self.create_study(
            T2StarStudy, 'test_frda', input_datasets={
                ...
                'betted_T1_mask': Dataset('test_frda_betted_T1_mask', nifti_gz_format),
                'betted_T1': Dataset('test_frda_betted_T1', nifti_gz_format),
                'betted_T2s_mask': Dataset('test_frda_betted_T2s_mask', nifti_gz_format),
                'betted_T2s': Dataset('test_frda_betted_T2s', nifti_gz_format),
                't2s': Dataset('test_frda_t2s', nifti_gz_format),
                'T2s_to_T1_mat': Dataset('test_frda_T2s_to_T1_mat', text_matrix_format)
        ...
        study.nonLinearT1ToMNI().run(work_dir=self.work_dir, plugin='MultiProc')
        self.assertDatasetCreated(dataset_name='t2s_in_t1.nii.gz', study_name=study.name)
