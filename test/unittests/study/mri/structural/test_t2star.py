...
#                                      study_name=study.name)        
    ...
    def test_ants_t2star(self):
        ...
        study.prepare_swi_coils(study_name='TEST',qsm_num_channels=32, qsm_echo_times=[7.38, 22.14]).run(work_dir=self.work_dir, subject_ids=['frda'], visit_ids=['F17p1'])#, plugin='MultiProc')
