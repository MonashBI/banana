...
from mbianalysis.data_format import nifti_gz_format, dicom_format  # @IgnorePep8
    ...
    def test_mc_ian(self):
        study = self.create_study(
            MotionDetectionStudy, 'mc_detection_study', inputs=[
                ...
                DatasetMatch('dwi_1_to_ref_dwi2ref_to_correct', dicom_format, 'dwi2ref_1_dicom'),
                DatasetMatch('dwi_1_opposite_opposite_dwi2ref_to_correct', dicom_format, 'dwi2ref_1_opposite_dicom'),
                DatasetMatch('dwi_1_main_dwi_main_ref', dicom_format, 'dwi2ref_1_opposite_dicom'),
                DatasetMatch('dwi_1_to_ref_dwi2ref_ref', dicom_format, 'dwi2ref_1_opposite_dicom'),
                DatasetMatch('dwi_1_opposite_opposite_dwi2ref_ref', dicom_format, 'dwi2ref_1_dicom'),
...
#                 DatasetMatch('dwi_1_main_motion_mats', directory_format, 'dwi_1_main_motion_mats'),
#                 DatasetMatch('dwi_1_opposite_motion_mats', directory_format, 'dwi_1_opposite_motion_mats'),
#                 DatasetMatch('dwi_1_to_ref_motion_mats', directory_format, 'dwi_1_to_ref_motion_mats')
                ])
