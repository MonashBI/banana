from nianalysis.analysis.mri.motion_detection_mixin import (
...
def run_md(input_dir, dynamic=False, xnat_id=None):
    ...
    analysis = cls(name='motion_detection', project_id=project_id,
                repository=repository, inputs=inputs)
    analysis.gather_outputs_pipeline().run(
        subject_ids=[sub_id],
