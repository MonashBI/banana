...
class FixedBinningInputSpec(BaseInterfaceInputSpec):
    ...
    start_times = File(desc='Start times of all the scans in the study. This '
                       'is generated by mean displacement calculation pipeline.')
...
class FixedBinningOutputSpec(TraitedSpec):
    ...
    average_bin_mats = Directory(desc='Directory with all the matrices to be used'
                                 'to realign the reconstructed fixed-binning PET'
                                 'images.')
