...
for i=0:(nCoils-1)
    nii = load_nii([inDir '/Unwrapped_Coil_' num2str(i) '_' num2str(echoId) '_PHASE.nii.gz']);
    ...
    save_nii(nii,[outDir '/TissuePhase_Coil_' num2str(i) '_' num2str(echoId) '_PHASE.nii.gz']);
    nii.img = NewMask<0;
    save_nii(nii,[outDir '/TissueMask_Coil_' num2str(i) '_' num2str(echoId) '_MASK.nii.gz']);
end
