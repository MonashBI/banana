...
mag = [];
for i=1:nCoils
    pNii = load_nii([inDir '/Raw_Coil_' num2str(i-1) '_1_PHASE.nii.gz']);
    mNii = load_nii([inDir '/Raw_Coil_' num2str(i-1) '_1_MAGNITUDE.nii.gz']);
    ...
    pNii = load_nii([inDir '/Raw_Coil_' num2str(i-1) '_2_PHASE.nii.gz']);
    mNii = load_nii([inDir '/Raw_Coil_' num2str(i-1) '_2_MAGNITUDE.nii.gz']);
